# Generated by Django 5.1.2 on 2025-01-08 18:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('HR', 'HR'), ('сотрудник', 'Сотрудник')], default='сотрудник', max_length=100, verbose_name='Роль')),
            ],
            options={
                'verbose_name': 'Роль',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.PROTECT, to='authenticate.role', verbose_name='Роль')),
            ],
            options={
